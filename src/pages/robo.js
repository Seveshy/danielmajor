...
const RoboPage = ({ data }) => (
  <Layout>
      <section className="section">
        ...
        <p className="">O Robô Instagram é o maior e mais popular ferramenta de automação do Instagram. Sua incrível variedade de recursos o torna a ferramenta uma boa opção para aumentar sua conta e direcionar seu público principal da melhor maneira possível.

        Ao simular o comportamento humano, não é apenas mais seguro do que a maioria das 
        ferramentas pagas existentes, mas também extremamente eficiente quando se trata de 
        alcançar novas pessoas e contas no Instagram. Pode curtir, comentar, 
        seguir e muitas outras interações que você mesmo teria que fazer para atingir um 
        público maior.</p>
